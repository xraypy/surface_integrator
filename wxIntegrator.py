...
class Integrator(wx.Frame, wx.Notebook):
        ...
        def __init__(self, *args, **kwargs):
            ...
            self.saveCTRab = self.fileMenu.Append(-1, 'Save CTR, alpha, beta',
                                                 'Write H, K, L, F, \n' + 
            ...
            # added April 2015, JES
            self.attenSizer.Add(self.transmLbl, proportion=1,
                              flag=wx.ALIGN_CENTER | wx.LEFT | wx.RIGHT,
                              border=4)
            self.attenSizer.Add(self.filtersLbl, proportion=1,
                              flag=wx.ALIGN_CENTER | wx.LEFT | wx.RIGHT,
                              border=4)
            self.attenSizer.Add(self.corrdetLbl, proportion=1,
                              flag=wx.ALIGN_CENTER | wx.LEFT | wx.RIGHT,
                              border=4)
            ...
            self.dataSizer2.Add(self.abSecSizer, proportion=1,
                                flag=wx.EXPAND | wx.LEFT, border=4)
            self.dataSizer2.Add(self.attenSizer, proportion=1,
                                flag=wx.EXPAND | wx.LEFT, border=4)
